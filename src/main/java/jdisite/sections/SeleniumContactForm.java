...
public class SeleniumContactForm {
    @UI("#name") WebElement name;
    @UI("#last-name") WebElement lastName;
    @UI("#position") WebElement position;
    @UI("#passport-number") WebElement passportNumber;
    @UI("#passport-seria") WebElement passportSeria;
    @UI("#passport") WebElement passport;
    // Dropdown
    @UI("#gender") WebElement genderExpand;
    @UI("#gender") List<WebElement> genderList;
    @UI("#gender") WebElement genderValue;
    // Combobox
    @UI("#gender") WebElement religion;
    // MultiDropdown
    @UI("#gender") WebElement weatherExpand;
    @UI("#gender") List<WebElement> weatherList;
    @UI("#gender") WebElement weatherValue;

    @UI("#accept-conditions") WebElement acceptConditions;
    @UI("#description") WebElement description;

    @UI("#contact-form [type=submit]") WebElement submit;
